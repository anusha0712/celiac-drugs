#!/usr/bin/env python3
"""
filter_bulk.py — Apply the 6-step filter pipeline to the bulk DailyMed catalog.
...
Input:  data/dailymed_bulk_raw.csv          (199,961 rows × 43 columns)
Output: data/bulk/dailymed_bulk_filtered.csv (~72,358 rows × 43 columns)

Run:
  python3 scripts/filter_bulk.py
"""
...
INPUT_CSV = BASE_DIR / "data" / "dailymed_bulk_raw.csv"
OUTPUT_CSV = BASE_DIR / "data" / "bulk" / "dailymed_bulk_filtered.csv"
