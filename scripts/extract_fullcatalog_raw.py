...
OUTPUT_FILE = os.path.join(PROJECT_DIR, "data", "fullcatalog", "dailymed_fullcatalog_raw.csv")
...
# ============================================================
# Helpers (from pull_dailymed_pilot.py)
# ============================================================
...
# ============================================================
# XML parsing (adapted from pull_dailymed_pilot.py parse_spl_xml)
# ============================================================
...
def parse_spl_xml(tree, setid):
    ...
    Adapted from pull_dailymed_pilot.py — no injectable filtering, no category param,
