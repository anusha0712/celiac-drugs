#!/usr/bin/env python3
"""
build_excipient_list.py — Extract gluten-adjacent excipients from the full DailyMed catalog.

Reads data/dailymed_bulk_raw.csv, identifies excipient strings that match
...
Output:
  data/bulk/excipient_research_worklist.csv
"""
...
PILOT_VALIDATION = BASE_DIR / "data" / "eda" / "excipient_validation.csv"
OUTPUT_DIR = BASE_DIR / "data" / "bulk"
