#!/usr/bin/env python3
"""
build_validation_table.py — One-time script to build data/bulk/excipient_validation.csv
...
Run:
  python3 build_validation_table.py
"""
...
BULK_CSV = BASE_DIR / "data" / "dailymed_bulk_raw.csv"
PILOT_CSV = BASE_DIR / "data" / "eda" / "excipient_validation.csv"
OUTPUT_CSV = BASE_DIR / "data" / "bulk" / "excipient_validation.csv"
...
# pharmacist consultation, etc.). The pilot CSV (data/eda/excipient_validation.csv)
...
NEW_ENTRIES = [
    ...
    # Pending pharmacist consultation (see analysis/validation_table_review.md Q3).
    ...
    # table is the single source of truth — re-running build_excipient_list.py
...
def main():
    print("Building data/bulk/excipient_validation.csv")
    print()
